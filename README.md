...
http://d3exsrv-41573.onmodulus.net/api/
...
## GET all states
curl -X GET http://d3exsrv-41573.onmodulus.net/api/states

## DELETE state ${oid}
curl -X DELETE http://d3exsrv-41573.onmodulus.net/api/states/${oid}

## INSERT state ${json}
curl -X POST -H "Content-Type: application/json" -d '{
  "state": "WA",
  "freq": { "low": 4786, "mid": 5319, "high": 2249 }
}' http://d3exsrv-41573.onmodulus.net/api/states
